...
export default function Faq() {
    return (
      <section className="mx-auto max-w-7xl py-40 2xl:px-0 px-6">
          ...
          <div className="md:col-span-3">
            <div className="hs-accordion-group divide-y divide-gray-200">
              ...
              >
                ...
                >
                  <p className="text-gray-600">
                    Visit our website, click &quot;Book Now,&quot; choose your
                    horse, date/time, and fill out the form.
                  </p>
                </div>
              </div>
              ...
              >
                ...
                >
                  <p className="text-gray-600">
                    No! We offer rides for all levels. Mention if you&apos;re a
                    beginner during booking.
                  </p>
                </div>
              </div>
              ...
              >
                ...
                >
                  <p className="text-gray-600">
                    Comfortable long pants, closed-toe shoes with good grip, and
              ...
              >
                ...
                >
                  What happens if it rains on my ride day?
                  <svg
                    className="hs-accordion-active:hidden block flex-shrink-0 size-5 text-gray-600 group-hover:text-gray-500"
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                ...
                >
                  <p className="text-gray-600">
                    We&apos;ll contact you to reschedule or offer a full refund
              ...
              >
                ...
                >
                  <p className="text-gray-600">
                    Yes! We offer both private and group rides. Specify your
                    preference when booking.For this you have schedule a call with us as this feature is currently in development phase.
                  </p>
                </div>
              </div>
            </div>
