...
export default function Form() {
  return (
    // <!-- Stepper -->
    <div data-hs-stepper="" className="flex flex-col justify-center px-6 h-full w-full max-xl:py-40">
      {/* <!-- Stepper Nav --> */}
      ...
      "index": 1
        ...
        >
          ...
          <div className="w-full h-px flex-1 bg-gray-200 group-last:hidden hs-stepper-success:bg-primary hs-stepper-completed:bg-primary-dark"></div>
        </li>
