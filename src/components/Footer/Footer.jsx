...
import logo from "../../assets/images/Text_Logo_Dark.svg";


export default function Footer() {
  return (
    <footer className="mt-auto mb-0 bg-gray-900 w-full">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6">
          <div className="col-span-full lg:col-span-1">
            <Link to="/#" aria-label="Brand">
              <img src={logo} alt="Logo Dark" className="h-8" />
            </Link>
          </div>
          ...
          <div className="col-span-2">
            ...
            <form>
              <div className="mt-4 flex flex-col items-center gap-2 sm:flex-row sm:gap-3 bg-white rounded-lg p-2">
                ...
                <Link
                  className="w-full sm:w-auto whitespace-nowrap p-3 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-primary text-white hover:bg-primary disabled:opacity-50 disabled:pointer-events-none"
                  to="/#"
                >
                  Subscribe
                </Link>
              ...
              <p className="mt-3 text-sm text-gray-400">
                Subscribe to be updated about latest offers.
              </p>
            </form>
          </div>
        </div>
        ...
        <div className="mt-5 sm:mt-12 grid gap-y-2 sm:gap-y-0 sm:flex sm:justify-between sm:items-center">
          <div className="flex justify-between items-center">
            <p className="text-sm text-gray-400">
              © {new Date().getFullYear()} SpurBook. All rights reserved.
            </p>
          </div>
          <div>
            <Link
